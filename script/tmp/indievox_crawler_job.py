from crawler.indievox_crawler.indievox_crawler_all_partner import IndievoxCrawlerAllPartner
from crawler_handle_data import CrawlerHandleData
...
def compare_S3_and_transfer_data_by_chat_gpt(item_data):
    print(" 子處理程序 ID:{}, concert_id:{}".format(
        os.getpid(), item_data.get('concert_info_id')))
...
if __name__ == '__main__':
    ...
    one_partner_concert_soup_list = indievoxCrawler.run_partner_page(
    ...
    if concert_list:
        ...
        list_S3_chat_gpt = [compare_S3_and_transfer_data_by_chat_gpt(
            item_data) for item_data in concert_item_list if item_data]
